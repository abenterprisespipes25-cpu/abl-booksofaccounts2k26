...
export const FUND_TO_GL_ACCOUNT: Record<string, string> = {
  ...
  "PCF-ACUÑA": "Petty Cash Fund - Leonilo Acuña",
  "PCF-WHITE": "Petty Cash Fund - Michael White",
  "PCF-DUCE": "Petty Cash Fund - Vanessa Anne Duce",
  "REV-OFFICE": "Revolving Fund - Office",
};
