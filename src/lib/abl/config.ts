...
export interface ColumnDef {
  ...
  header2?: string;
  field: string;
  type: "date" | "text" | "currency" | "formula";
  width?: number;
  creditCol?: boolean;
}
...
export const CDB_COLUMNS: ColumnDef[] = [
  ...
  { header: "TRAVEL SALES", header1: "", header2: "SALES", field: "travel_sales", type: "currency", width: 12 },
  { header: "TRAVEL CONST", header1: "TRAVEL & TRANSPORTATION", header2: "CONSTRUCTION", field: "travel_construction", type: "currency", width: 12 },
  { header: "TRAVEL WATER", header1: "", header2: "WATER", field: "travel_water", type: "currency", width: 12 },
  ...
  { header: "SUNDRIES DR", header1: "A M O U N T", header2: "DR", field: "sundries_dr", type: "currency", width: 12 },
  { header: "SUNDRIES CR", header1: "", header2: "CR.", field: "sundries_cr", type: "currency", width: 12 },
];
