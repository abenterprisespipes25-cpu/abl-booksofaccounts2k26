...
export const FUND_MAP: Record<string, string> = {
  "CIB:BDO Admin": "CIB:BDO Admin",
  "CIB:BDO Plant": "CIB:BDO Plant",
  "CIB:BDO ATSA": "CIB:BDO ATSA",
  "CIB:LBP": "CIB:LBP",
  "CIB:BDO Dollar Savings": "CIB:BDO Dollar Savings",
  "COH:Petty Cash Fund - ASTL Plant": "COH:Petty Cash Fund - ASTL Plant",
  "COH:Petty Cash Fund - Leonilo Acuña": "COH:Petty Cash Fund - Leonilo Acuña",
  "COH:Petty Cash Fund - Michael White": "COH:Petty Cash Fund - Michael White",
  "COH:Revolving Fund - Office": "COH:Revolving Fund - Office",
  "CIB:Eastwest": "CIB:Eastwest",
  "CIB:Eastwest Dollar Savings": "CIB:Eastwest Dollar Savings",
  "CIB:LBP DOST": "CIB:LBP DOST",
  "COH:Petty Cash Fund- Vanessa Anne Duce": "COH:Petty Cash Fund- Vanessa Anne Duce",
  "COH:Petty Cash Fund - ASTL Construction": "COH:Petty Cash Fund - ASTL Construction",
};
...
export const FUND_TO_GL_ACCOUNT: Record<string, string> = {
  ...
  "CIB:LBP": "CIB - LBP",
  "CIB:BDO Dollar Savings": "CIB - BDO Dollar Savings",
  "COH:Petty Cash Fund - ASTL Plant": "Petty Cash Fund - ASTL Plant",
  "COH:Petty Cash Fund - Leonilo Acuña": "Petty Cash Fund - Leonilo Acuña",
  "COH:Petty Cash Fund - Michael White": "Petty Cash Fund - Michael White",
  "COH:Revolving Fund - Office": "Revolving Fund - Office",
  "CIB:Eastwest": "CIB - Eastwest",
  "CIB:Eastwest Dollar Savings": "CIB - Eastwest Dollar Savings",
  "CIB:LBP DOST": "CIB - LBP DOST",
  "COH:Petty Cash Fund- Vanessa Anne Duce": "Petty Cash Fund- Vanessa Anne Duce",
  "COH:Petty Cash Fund - ASTL Construction": "Petty Cash Fund - ASTL Construction",
};
...
export const CDB_COLUMNS: ColumnDef[] = [
  ...
  { header: "A/P TRADE", header1: "ACCOUNTS", header2: "PAYABLE-TRADE", field: "ap_trade_dr", type: "currency", width: 10 },
  { header: "VAT INPUT TAX", header1: "VAT", header2: "INPUT TAX", field: "vat_input_tax", type: "currency", width: 10 },
  { header: "DIRECT LABOR", header1: "DIRECT", header2: "LABOR / BASIC", field: "direct_labor_basic", type: "currency", width: 10 },
  { header: "OVERHEAD LABOR", header1: "OVERHEAD", header2: "LABOR / BASIC", field: "overhead_labor_basic", type: "currency", width: 10 },
  { header: "COMM LIGHT WATER PLANT", header1: "COMM., LIGHT &", header2: "WATER-PLANT", field: "comm_light_water_plant", type: "currency", width: 10 },
  { header: "COMM LIGHT WATER ADMIN", header1: "COMM., LIGHT &", header2: "WATER-ADMIN", field: "comm_light_water_admin", type: "currency", width: 10 },
  { header: "COMM LIGHT WATER SALES", header1: "COMM., LIGHT &", header2: "WATER-SALES", field: "comm_light_water_sales", type: "currency", width: 10 },
  { header: "ITW TOP 10K", header1: "ITW", header2: "TOP 10K CORP.", field: "itw_top_10k_corp", type: "currency", width: 10 },
  ...
  { header: "SSS PHIC HDMF PREM", header1: "SSS, PHIC & HDMF", header2: "PREM. PAYABLE", field: "sss_phic_hdmf_prem", type: "currency", width: 10 },
  { header: "SSS HDMF LOAN", header1: "SSS/HDMF", header2: "LOAN PAYABLE", field: "sss_hdmf_loan", type: "currency", width: 10 },
  { header: "OUTSIDE SERVICES", header1: "OUTSIDE SERVICES", header2: "Construction", field: "outside_services_construction", type: "currency", width: 10 },
  { header: "TRAVEL ADMIN", header1: "TRAVEL &", header2: "TRANSPORTATION ADMIN.", field: "travel_admin", type: "currency", width: 10 },
  { header: "TRAVEL SALES", header1: "TRAVEL &", header2: "TRANSPORTATION SALES", field: "travel_sales", type: "currency", width: 10 },
  { header: "TRAVEL CONST", header1: "TRAVEL &", header2: "TRANSPORTATION CONST.", field: "travel_construction", type: "currency", width: 10 },
  { header: "TRAVEL WATER", header1: "TRAVEL &", header2: "TRANSPORTATION WATER", field: "travel_water", type: "currency", width: 10 },
