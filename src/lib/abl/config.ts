...
export const FUND_TO_GL_ACCOUNT: Record<string, string> = {
  ...
  "BDO-DOLLAR": "CIB:BDO Dollar Savings",
  "EASTWEST": "CIB:Eastwest",
  "EW-DOLLAR": "CIB:Eastwest Dollar Savings",
  "LBP": "CIB:LBP",
  "LBP-DOST": "CIB:LBP DOST",
  "PCF-PLANT": "COH:Petty Cash Fund - ASTL Plant",
  "PCF-CONST": "COH:Petty Cash Fund - ASTL Construction",
  "PCF-ACUÑA": "COH:Petty Cash Fund - Leonilo Acuña",
  "PCF-WHITE": "COH:Petty Cash Fund - Michael White",
  "PCF-DUCE": "COH:Petty Cash Fund - Vanessa Anne Duce",
  "REV-OFFICE": "COH:Revolving Fund - Office",
};
