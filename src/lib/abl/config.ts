...
export const CDB_COLUMNS: ColumnDef[] = [
  { header: "DATE", header1: "DATE", header2: "JAN., 2025", field: "entry_date", type: "date", width: 10 },
  { header: "PAYEE", header1: "DATE", header2: "PAYEE", field: "payee", type: "text", width: 25 },
  { header: "PARTICULARS", header1: "DATE", header2: "PARTICULARS", field: "particulars", type: "text", width: 30 },
  { header: "PETTY CASH VOUCHER", header1: "PETTY CASH", header2: "VOUCHER NO.", field: "petty_cash_voucher", type: "text", width: 12 },
  { header: "CHECK VOUCHER NO.", header1: "CHECK", header2: "VOUCHER NO.", field: "check_voucher_no", type: "text", width: 12 },
  { header: "CHECK NO.", header1: "CASH", header2: "CHECK NO.", field: "check_no", type: "text", width: 10 },
  { header: "FUND", header1: "CASH", header2: "FUND", field: "fund", type: "text", width: 10 },
  ...
  { header: "TRAVEL ADMIN", header1: "TRAVEL & TRANSPORTATION", header2: "ADMIN.", field: "travel_admin", type: "currency", width: 12 },
  { header: "TRAVEL SALES", header1: "TRAVEL & TRANSPORTATION", header2: "SALES", field: "travel_sales", type: "currency", width: 12 },
  { header: "TRAVEL CONST", header1: "TRAVEL & TRANSPORTATION", header2: "CONSTRUCTION", field: "travel_construction", type: "currency", width: 12 },
  { header: "TRAVEL WATER", header1: "TRAVEL & TRANSPORTATION", header2: "WATER", field: "travel_water", type: "currency", width: 12 },
  ...
  { header: "SUNDRIES DR", header1: "A M O U N T", header2: "DR", field: "sundries_dr", type: "currency", width: 10 },
  { header: "SUNDRIES CR", header1: "A M O U N T", header2: "CR.", field: "sundries_cr", type: "currency", width: 10 },
];
